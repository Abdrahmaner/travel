...
// import Home_index from "./Pages/Home/Home_index";
// import Footer from "./StateLess_componenets/Footer";
                                ...
                                <div id="offer-box" className="carouselTicker">
                                    <ul className="offer-box">
                                        <li>
                                            ...
                                            20% off Entire Purchase Promo code:
                                            offT80
                                        </li>
                                        <li>
                                            <i className="fab fa-opencart"></i>{" "}
                            ...
                            <ul className="cart-list">
                                <li>
                                    <a href="#" className="photo">
                                        <img
                                            src="template/images/img-pro-01.jpg"
                                ...
                                <li>
                                    <a href="#" className="photo">
                                        <img
                                            src="template/images/img-pro-02.jpg"
                                            className="cart-thumb"
                                            alt=""
                                        />
                                    </a>
                                ...
                                <li>
                                    <a href="#" className="photo">
                                        <img
                                            src="template/images/img-pro-03.jpg"
                                            className="cart-thumb"
                                            alt=""
                                        />
                                    </a>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-md-12">
                                    ...
                                    <p className="m-b-40">
                                        See how your users experience your
                                        website in realtime or view <br />{" "}
                                        trends to see any changes in performance
                                        over time.
                                    </p>
                                    <p>
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div className="shop-cat-box">
                                <img
                                    className="img-fluid"
                                    src="template/images/categories_img_01.jpg"
                                    alt=""
                                />
                                <a className="btn hvr-hover" href="#">
                                    Lorem ipsum dolor
                        ...
                        <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div className="shop-cat-box">
                                <img
                                    className="img-fluid"
                                    src="template/images/categories_img_02.jpg"
                                    alt=""
                                />
                                <a className="btn hvr-hover" href="#">
                                    Lorem ipsum dolor
                        ...
                        <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div className="shop-cat-box">
                                <img
                                    className="img-fluid"
                                    src="template/images/categories_img_03.jpg"
                                    alt=""
                                />
                                <a className="btn hvr-hover" href="#">
                                    Lorem ipsum dolor
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-12">
                            <div className="offer-box-products">
                                <img
                                    className="img-fluid"
                                    src="template/images/add-img-01.jpg"
                                    alt=""
                                />
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6 col-sm-12">
                            <div className="offer-box-products">
                                <img
                                    className="img-fluid"
                                    src="template/images/add-img-02.jpg"
                                    alt=""
                                />
                            </div>
                        </div>
                        ...
                        <div className="col-lg-12">
                            <div className="special-menu text-center">
                                <div className="button-group filter-button-group">
                                    ...
                                    <button data-filter=".top-featured">
                                        Top featured
                                    </button>
                                    <button data-filter=".best-seller">
                                        Best seller
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-3 col-md-6 special-grid best-seller">
                            <div className="products-single fix">
                                <div className="box-img-hover">
                                    ...
                                    <img
                                        src="template/images/img-pro-04.jpg"
                                        className="img-fluid"
                                        alt="Image"
                                    />
                                    <div className="mask-icon">
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-4">
                            <div className="blog-box">
                                <div className="blog-img">
                                    <img
                                        className="img-fluid"
                                        src="template/images/blog-img.jpg"
                                        alt=""
                                    />
                                </div>
                                <div className="blog-content">
                                    <div className="title-blog">
                                        <h3>
                                            Fusce in augue non nisi fringilla
                                        </h3>
                                        <p>
                                            Nulla ut urna egestas, porta libero
                                            id, suscipit orci. Quisque in lectus
                                            sit amet urna dignissim feugiat.
                                            Mauris molestie egestas pharetra. Ut
                                            finibus cursus nunc sed mollis.
                                            Praesent laoreet lacinia elit id
                                            lobortis.
                                        </p>
                                    </div>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-4">
                            <div className="blog-box">
                                <div className="blog-img">
                                    <img
                                        className="img-fluid"
                                        src="template/images/blog-img-01.jpg"
                                        alt=""
                                    />
                                </div>
                                <div className="blog-content">
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-4">
                            <div className="blog-box">
                                <div className="blog-img">
                                    <img
                                        className="img-fluid"
                                        src="template/images/blog-img-02.jpg"
                                        alt=""
                                    />
                                </div>
                                <div className="blog-content">
                ...
                <div className="main-instagram owl-carousel owl-theme">
                    <div className="item">
                        <div className="ins-inner-box">
                            <img
                                src="template/images/instagram-img-01.jpg"
                                alt=""
                            />
                    ...
                    <div className="item">
                        <div className="ins-inner-box">
                            <img
                                src="template/images/instagram-img-02.jpg"
                                alt=""
                            />
                            <div className="hov-in">
                                <a href="#">
                    ...
                    <div className="item">
                        <div className="ins-inner-box">
                            <img
                                src="template/images/instagram-img-03.jpg"
                                alt=""
                            />
                            <div className="hov-in">
                                <a href="#">
                    ...
                    <div className="item">
                        <div className="ins-inner-box">
                            <img
                                src="template/images/instagram-img-04.jpg"
                                alt=""
                            />
                            <div className="hov-in">
                                <a href="#">
                    ...
                    <div className="item">
                        <div className="ins-inner-box">
                            <img
                                src="template/images/instagram-img-05.jpg"
                                alt=""
                            />
                            <div className="hov-in">
                                <a href="#">
                    ...
                    <div className="item">
                        <div className="ins-inner-box">
                            <img
                                src="template/images/instagram-img-06.jpg"
                                alt=""
                            />
                            <div className="hov-in">
                                <a href="#">
                    ...
                    <div className="item">
                        <div className="ins-inner-box">
                            <img
                                src="template/images/instagram-img-07.jpg"
                                alt=""
                            />
                            <div className="hov-in">
                                <a href="#">
                    ...
                    <div className="item">
                        <div className="ins-inner-box">
                            <img
                                src="template/images/instagram-img-08.jpg"
                                alt=""
                            />
                            <div className="hov-in">
                                <a href="#">
                    ...
                    <div className="item">
                        <div className="ins-inner-box">
                            <img
                                src="template/images/instagram-img-09.jpg"
                                alt=""
                            />
                            <div className="hov-in">
                                <a href="#">
