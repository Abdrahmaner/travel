...
>
  <head>
    ...
    <script src="https://kit.fontawesome.com/66f5127731.js" crossorigin="anonymous"></script>
...
<!-- / Navbar -->
    ...
    {{-- js validation --}}
    <script src="https://unpkg.com/just-validate@latest/dist/just-validate.production.min.js"></script>    {{-- sweetalert --}}
    ...
    <!-- endbuild -->
    <script type="text/javascript" src="{{asset('assets/assets/js/pagination.js')}}"></script>
    <!-- Vendors JS -->
