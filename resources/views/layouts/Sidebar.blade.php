...
<ul class="menu-inner py-1">
  ...
  <li class="menu-item">
    ...
    <ul class="menu-sub">
      <li class="menu-item">
        <a href="{{ route('displayAdmin') }}"class="menu-link">
  ...
  <li class="menu-item">
    ...
    <ul class="menu-sub">
      <li class="menu-item">
        <a href="{{ route('produit') }}" class="menu-link">
          <div data-i18n="Account">Display Products</div>
        </a>
      </li>
      {{-- <li class="menu-item">
    ...
    <ul class="menu-sub">
      <li class="menu-item">
        <a href="{{ route('categorie') }}" class="menu-link">
          <div data-i18n="Basic">Display categories</div>
        </a>
      </li>
      {{-- <li class="menu-item">
